...
const date_original = reorder/product_components;
...
const diferencia = date_function_utc - date_original; // Calcular la diferencia en milisegundos
const diferencia_decisegundos = Math.floor(diferencia / 100); // Convertir la diferencia a décimas de segundo

//console.log("Redondedo independiente:", Math.floor(date_original/100), Math.floor(date_function_utc/100));

console.log("Diferencia:", diferencia_decisegundos)
if (diferencia_decisegundos<6) {
    console.log("Válido")
} else {
